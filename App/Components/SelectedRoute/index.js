...
export default class SelectedRoute extends Component {
    ...
    render() {
        const {item: {locationName = 'No Location', name = 'No Task', noOfTaskCompleted = 0, noOfTask = 0}, onCloseTask} = this.props
        return (
            <LinearGradient start={{x: 0, y: 0.3}} end={{x: 0, y: 0.8}}
                ...
                <View style={styles.contentContainer}>
                    <View style={styles.accomplishedContainer}>
                        <Text style={styles.accomplished}>{`${noOfTaskCompleted} Out of ${noOfTask} Accomplished`}</Text>
